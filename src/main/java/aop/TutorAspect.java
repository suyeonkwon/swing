...
public class TutorAspect {
	...
	public Object TutorLoginCheck(ProceedingJoinPoint joinPoint) throws Throwable {
		User loginUser  = null;
	...
	public Object TutorAdminCheck(ProceedingJoinPoint joinPoint,HttpSession session,String id) throws Throwable{
